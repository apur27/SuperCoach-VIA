...
Generate the "<YEAR> team analysis" section in docs/afl-insights.md from
the latest season's player-game data, plus a "5-year team playing styles"
section covering the five seasons immediately prior to the current year.
...
6. Writes the current-season section into docs/afl-insights.md between the
   markers
