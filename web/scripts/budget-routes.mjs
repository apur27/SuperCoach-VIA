...
export const ROUTES = [
  { route: '', json: [] },
  { route: 'predictions/', json: [R, { kind: 'prediction_index', glob: 'predictions/index.json' }, { kind: 'prediction_set', glob: 'predictions/*/*.json' }] },
  ...
  { route: 'accuracy/', json: [R, { kind: 'accuracy_report', glob: 'accuracy/*/*.json' }] },
  { route: 'articles/', json: [] },
  { route: 'lists/', core: false, json: [R, { kind: 'lists_season', glob: 'lists/*.json', exclude: ['lists/index.json'] }] },
  { route: 'live/', core: false, json: [R, { kind: 'live_snapshot', glob: 'live/*/*.json' }] },
