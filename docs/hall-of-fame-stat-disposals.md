...
|--:|--------|---------|------|------:|----------:|---------:|
| 1 | Scott Pendlebury **[data]** | Collingwood | 2006-2026 | 433 | 10,933 | 25.25 |
...
| 11 | Lachie Neale **[data]** | Brisbane Lions - Fremantle | 2012-2026 | 305 | 8,330 | 27.31 |
| 12 | Steele Sidebottom **[data]** | Collingwood | 2009-2026 | 364 | 8,296 | 22.79 |
| 13 | Patrick Dangerfield **[data]** | Adelaide - Geelong | 2008-2026 | 367 | 8,282 | 22.57 |
...
**Pendlebury leads, narrowly.** Pendlebury 10,933 **[data]** is the first 10,000-disposal career, and the only one. Robert Harvey 9,656 **[data]** sits second, 1,277 disposals back; Brent Harvey 9,213 **[data]** and Bartlett 9,151 **[data]** are next in line. Lachie Neale at 27.31 disposals per game **[data]** is the highest per-game rate in the top 20, ahead of Sam Mitchell's 26.40 **[data]** and West's 25.38 **[data]**. *Structuralist lens:* Pendlebury's volume is the product of a 21-year career, not an unusually high per-game rate - his 25.25 average **[data]** is mid-pack against the modern midfielders. The combination of moderate-high rate sustained across an unbroken career is what distinguishes him from Harvey and Bartlett, both of whom averaged similar disposal rates over comparable career lengths.

**Kick-to-handball composition has flipped.** This list contains both Bartlett (the all-time kicks leader at 8,293 **[data]**, see [kicks page](hall-of-fame-stat-kicks-handballs.md)) and Pendlebury (the all-time handballs leader at 5,477 **[data]**). Bartlett's career: 8,293 kicks + 858 handballs ≈ 9,151 disposals - 90% by foot. Pendlebury's career: 5,456 kicks + 5,477 handballs **[data]** = 10,933 disposals - 50/50 by composition. *Tempo Architect lens:* the modern midfielder is structurally a handballer-distributor first; the 1970s midfielder was a kicker-finder. The "disposal" stat treats both equally but they are functionally different actions - a kick advances territory, a handball maintains possession. The fact that Pendlebury sits above Bartlett on disposals while Bartlett still leads kicks reflects a sport that has shifted from territory to retention as the primary midfield function.
