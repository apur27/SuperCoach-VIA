...
**The key-forward assist contribution.** Hawkins 296 **[data]**, J. Riewoldt 249 **[data]**, Walker 240 **[data]**, Franklin 231 **[data]**, N. Riewoldt 224 **[data]** - five key forwards in the top 16. *Tempo Architect lens:* the modern key forward is also expected to be a distributor - the high mark on the wing, the handball-out from a marking contest, the centring kick from the boundary line. Hawkins's 296 is particularly notable: his forward-fifty work as a marking target produced both his own goals (796 **[data]** career, see [goals page](hall-of-fame-stat-goals.md)) and roughly one assist every fourth game. The role evolution from "finisher only" to "finisher and creator" is one of the most measurable shifts of the post-2010 forward-line.

**Bontempelli's projected trajectory.** Bontempelli 238 assists in 269 games at 0.88/game **[data]** is the highest per-game rate among players still in their twenties. *Talent Developer lens:* if he plays out another 80-100 games at his current rate, his career total will clear 350 and overhaul Pendlebury's mark. His role - the centre-bounce midfielder who pushes forward in the inside-50 and either takes the mark or finds the open teammate - is built around the assist outcome. The next decade's leaderboard will likely have Bontempelli and Daicos at #1 and #2.
