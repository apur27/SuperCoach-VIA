...
---
## Part 6 — The Geelong Model: Winning Without Drafting Well

If Richmond is the cautionary tale, Geelong is the puzzle that resists the obvious moral. The natural lesson to draw from twenty years of conversion data is that the clubs who win are the clubs who draft best — that elite-grade players are the raw material of premierships, and that the path to sustained success runs through the top of the draft. Geelong breaks that story cleanly in half. From 89 picks across 2004–2025, the club produced 9 A+/A players, a 10.1% rate **[data]** — not the best, not the worst, but exactly league average, 8th of 18 clubs. By the measure this entire series has used to separate the strong processes from the weak, Geelong is unremarkable. And yet they have collected four premierships since 2007 and have not bottomed out once in the intervening years. The mismatch is the whole point: drafting is necessary for sustained competitiveness, but it is plainly not sufficient, and it is plainly not the only lever.

What makes Geelong's average drafting more interesting than it first appears is *where* on the board their elite players were found. Their average pick per A+/A player is 27.7 **[data]** — 14th of 18 clubs, meaning they unearth elites later in the draft than almost anyone. Set that against Carlton, whose A+/A players arrived at an average pick of 6.0 **[data]** — all of them top-ten selections — yet whose overall conversion sits at 8.8% **[data]**, below league average, with no recent premiership to show for the privilege of picking early. Carlton's model is high picks and mediocre conversion. Geelong's is the inverse: ordinary draft position turned into elite outcomes through evaluation. Two of their three A+ players make the case unmissable. Tom Hawkins came at pick 41 (359 games, 796 goals **[data]**) and Tom Stewart at pick 40 (204 games **[data]**) — both found past pick 40, in the stretch of the draft where most clubs treat selection as a formality and list-fill. Geelong has never held a top-five pick in this entire 2004–2025 dataset. Their edge is not access. It is the rigour they apply where other clubs are coasting.

The draft, though, is only one of three pathways, and reading Geelong purely as a drafting story misses what may be the more decisive half of the model. The two most important imports of the club's modern era were not drafted there at all. Patrick Dangerfield (370 games **[data]**, still active through Round 15 2026) arrived via trade from Adelaide; Jeremy Cameron (293 games **[data]**, active through Round 15 2026) via trade from GWS. Both were identified as elite-grade talents already proven at other clubs and acquired in the trade market — the same analytical seriousness Geelong brings to a pick-40 selection, applied to a different acquisition channel. A club that finds Hawkins at 41 and also lands Dangerfield and Cameron through trade is running two talent pipelines in parallel, not one. The draft table flatters the clubs who live and die by it; it cannot see the players a smart club buys.

The third component is retention, and it is the quietest of the three because it never produces a headline pick. Mark Blicavs — 306 games and still active in Round 15 2026 **[data]** — and Dangerfield at 370 are the visible edge of a club that extracts maximum career value from each player it holds. Geelong's listed veterans tend to play at a high level for longer than the league norm, which means the environment around them — the coaching system, the physical preparation, the cultural standards that survive any single departure — is functionally adding games and seasons that other clubs lose to earlier decline or earlier exit. Every season a productive 30-something keeps playing is a draft pick the club did not have to convert.

So the lesson of Geelong is not that drafting does not matter — it plainly does, and a club drafting at 5% rather than 10% would feel the difference acutely. The lesson is that an *average* draft process can outperform a superior one when it is paired with two other disciplines: genuine evaluation rigour in the late draft, and intelligent use of the trade market and retention. The Western Bulldogs convert at 15.6% **[data]** and are rightly admired for it; Geelong converts at exactly half-again less and has more premierships across the window. The model works not because any one component is best-in-league, but because all three are in place at once. That is the harder thing to copy, and the reason the table at the top of the efficiency ladder does not, on its own, predict the table that matters in September.

---
## Part 7 — The Data Playbook: What an AFL Club Should Actually Do

Everything in the previous six parts reduces to a set of rules a club could write on one page and apply to every pick in every draft. They are not secrets. They are extractable from the data, and the clubs near the top of the efficiency table are simply the ones applying them consistently. Here is the playbook.

1. **There is no substitute for a top-5 pick.** Picks 1–5 convert to A+/A at 37.3% **[data]** — nearly two in five. No other range comes close. Every draft strategy starts from this fact: a genuine top-five selection is the most valuable asset a club can hold, and it should not be traded for volume unless the return is genuinely exceptional. The arithmetic of the draft begins at the top, and the top is scarce.

2. **Price the cliff correctly in trade negotiations.** Picks 11–15 convert at 20.0% **[data]** — statistically level with picks 6–10 at 19.1% **[data]** — while picks 16–20 fall to 9.1% **[data]**. The drop is a cliff, not a slope, and it sits right after pick 15. Any trade market that treats picks 11–15 as ordinary end-of-first-round value is mispricing them. That band is the single best place to buy.

3. **Apply the school signal at 11–30, not at 1–10.** At picks 1–10, an elite-school background carries no measurable conversion premium (29% vs 28% **[data]**) — the talent is obvious enough that the signal adds nothing. At picks 11–15, the gap is real and large: 30.4% vs 17.2% **[data]**, a near-2× premium. Use the signal as a tiebreaker where it actually pays, and ignore it where it does not.

4. **Discount the SA pipeline; the WA mythology is overrated.** State-of-origin conversion runs VIC 11.9% **[data]**, WA 11.5% **[data]**, SA 5.4% **[data]**. WA is not the gold mine its reputation suggests — it matches Victoria almost exactly. South Australia underperforms dramatically, at less than half the rate of the other two. Interstate weighting should reflect the numbers, not the folklore.

5. **Work the late draft as a real market, not a formality.** Between 2004 and 2025, 18 A+/A players **[data]** were drafted after pick 50 — a conversion rate of roughly 4–6% **[data]**. It is low, but it is not zero, and it is the difference between treating picks 51+ as list-fill and treating them as a 1-in-16 shot at an elite career. The clubs that find Hawkins at 41 are the clubs that work these picks properly.

6. **Benchmark your process every single year.** Club efficiency ranges from 15.6% to 5.7% **[data]** across 18 clubs over more than 20 years. A 3-to-1 spread sustained over two decades and ninety-odd picks per club is a process story, not a luck story. Know where your club sits on that ladder. The Western Bulldogs and GWS are not lucky; they are repeatable — and repeatability is the only thing a process can be judged on.
