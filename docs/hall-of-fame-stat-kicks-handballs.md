...
> ✓ All 47 stats verified against source data · council-pipeline-gated · 2026-07-13
...
Kicks and handballs are the two components of disposals. The split matters because the actions are tactically opposite: a kick advances territory but risks turnover; a handball maintains possession but does not advance. Separating the two reveals what type of ball-user a midfielder is. A career kicks leader is fundamentally a foot-skill, territory-game player. A career handballs leader is a chains-and-retention midfielder.

The [disposals page](hall-of-fame-stat-disposals.md) shows the combined leaderboard. This page shows the split.

## Top 20 - all-time career kicks

| # | Player | Club(s) | Span | Games | Kicks | Per game |
|--:|--------|---------|------|------:|------:|---------:|
| 1 | Kevin Bartlett **[data]** | Richmond | 1965-1983 | 403 | 8,293 | 20.58 |
| 2 | Michael Tuck **[data]** | Hawthorn | 1972-1991 | 426 | 6,353 | 14.91 |
| 3 | Leigh Matthews **[data]** | Hawthorn | 1969-1985 | 332 | 6,017 | 18.12 |
| 4 | Craig Bradley **[data]** | Carlton | 1986-2002 | 375 | 5,876 | 15.67 |
| 5 | Wayne Richardson **[data]** | Collingwood | 1966-1978 | 277 | 5,829 | 21.04 |
...
| 9 | Scott Pendlebury **[data]** | Collingwood | 2006-2026 | 435 | 5,497 | 12.64 |
...
| 13 | Heath Shaw **[data]** | Collingwood - Greater Western Sydney | 2005-2020 | 325 | 5,062 | 15.58 |
...
## Top 20 - all-time career handballs

| # | Player | Club(s) | Span | Games | Handballs | Per game |
|--:|--------|---------|------|------:|----------:|---------:|
| 1 | Scott Pendlebury **[data]** | Collingwood | 2006-2026 | 435 | 5,531 | 12.71 |
| 2 | Lachie Neale **[data]** | Brisbane Lions - Fremantle | 2012-2026 | 308 | 4,690 | 15.23 |
...
| 9 | Jack Macrae **[data]** | St Kilda - Western Bulldogs | 2013-2026 | 280 | 4,098 | 14.64 |
...
| 13 | Patrick Dangerfield **[data]** | Adelaide - Geelong | 2008-2026 | 371 | 3,920 | 10.57 |
| 14 | Patrick Cripps **[data]** | Carlton | 2014-2026 | 244 | 3,882 | 15.91 |
| 15 | David Mundy **[data]** | Fremantle | 2005-2022 | 376 | 3,851 | 10.24 |
| 16 | Rory Laird **[data]** | Adelaide | 2013-2026 | 281 | 3,905 | 13.90 |
| 17 | Luke Parker **[data]** | North Melbourne - Sydney | 2011-2026 | 329 | 3,855 | 11.72 |
| 18 | Matt Priddis **[data]** | West Coast | 2006-2017 | 240 | 3,815 | 15.90 |
| 19 | Simon Black **[data]** | Brisbane Lions | 1998-2013 | 322 | 3,781 | 11.74 |
| 20 | Clayton Oliver **[data]** | Greater Western Sydney - Melbourne | 2016-2026 | 219 | 3,712 | 16.95 |

## FootyStrategy tactical read

**Two leaderboards, almost no overlap.** Only four names appear on both top-20 lists: Pendlebury (kicks #9, handballs #1) **[data]**, Robert Harvey (#7 / #10) **[data]**, Gary Ablett jnr (#20 / #6) **[data]**, and Boak (not on kicks top 20, #3 handballs). Every other name is one or the other. *Structuralist lens:* this is the clearest evidence on the site that "midfielder" is not a single role. The career-kicks leaderboard is dominated by 1970s-80s players whose primary disposal was the kick (Bartlett, Tuck, Matthews, Bradley, Richardson, Murphy, Nankervis). The career-handballs leaderboard is dominated by post-2000 inside midfielders whose primary disposal is the handball (Pendlebury, Neale, Selwood, Kennedy, Macrae, Treloar, Cripps).
...
- **Kicks tracked reliably from 1965** for most teams; some 1960s coverage is patchy.
- **Handballs under-recorded before 1965** - several pre-1965 greats (Polly Farmer notably) are not on the handballs list because the data does not exist.
- **Both stats are reliable from 1970 onward** for the full league.

## Methodology

Sum of per-game `kicks` and `handballs` fields across each player's career. Per-game rates are total ÷ games_played.

---

> Auto-generated tables from `docs/hall-of-fame/_stat_leaders.json`. Reproduce by running `docs/hall-of-fame/compute_stat_leaders.py`.
