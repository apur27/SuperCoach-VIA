...
|---|---|---|---|
| 2026-06-16 | [The AFL National Draft: Error, Structure, and the Shape of Talent](../articles/afl-draft-analysis-2024.md) | 2-part analytical piece on draft error taxonomy (commission vs omission), elite school pipeline (1,538 National picks, 2004–2025), superdraft depth, and mid-season draft dynamics | Complete (Scientist + FootyStrategy layers) |
