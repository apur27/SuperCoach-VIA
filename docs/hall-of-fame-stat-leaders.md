...
![All-time top 20 disposal-getters](../assets/charts/hall/alltime_top20_disposals.png)
...
![All-time top 20 tacklers](../assets/charts/hall/alltime_top20_tackles.png)
...
Look across the boards on this page and three structural stories come into focus that no individual leaderboard can tell on its own.

**The goals leaderboard is a museum, the disposal leaderboard is a stock exchange.** Of the top six career goalkickers (Lockett, Coventry, Dunstall, Franklin, Wade, Ablett Sr), exactly one - Franklin - played a game after the year 2000. Of the top twenty career disposal-getters, exactly one - Bartlett - played a game before 1988. These two lists do not overlap because they are measuring two different sports. Pre-2000 football was a scoring contest run through dominant key forwards; modern football is a possession contest run through midfielders, with the key forward demoted from primary architect of victory to one of three or four roles that contribute to it. Lockett's 1,360 - **[data]** verified to the game - will stand as the all-time scoring record indefinitely not because no one can match his finishing, but because the *structure* that produced 130-goal seasons (one or two leads a quarter, no zone defence, full-forwards locked one-on-one) no longer exists. The fact that Hawkins finished his career at 796 goals - a Tom Hawkins season was the best 2010s-2020s forward season - and is still 264 goals short of Franklin is the most direct measurement we have of how much the modern game suppresses scoring.

**The single-season records reveal where the rules changed.** Hudson's 150 goals in 1971, Pratt's 150 in 1934, Dunstall's 145 in 1992 - these are the upper limit of what is physically possible from a full-forward given the rules of the day. The fact that no one has come close in 30 years is not about the players. It is about zone defence, the post-2000 interchange rule changes that let teams rotate fresher defenders, and the post-2010 third-man-up structures that disrupt forward-50 marking. Compare to the disposal single-season records: Macrae's 880 in 2021, Tom Mitchell's 848 in 2018, Matt Crouch's 825 in 2017 **[data]** - every entry on that list comes from the last decade. The midfielder workload has been engineered upward by exactly the same rule changes that engineered scoring downward.

**The leadership names that show up everywhere.** Pendlebury appears at #1 in disposals, #1 in tackles, #1 in handballs, #1 in goal assists, #4 in Brownlow votes, and top-three in games. This is not a coincidence; it is the modern game's redefinition of leadership. The new captain-template is a contested-ball midfielder who distributes more than he finishes - Selwood and Bartel before Pendlebury, Bontempelli and Cripps after him. Compare to the great captains of the 1960s-1980s on the [captains page](hall-of-fame-captains.md) - centre half-forwards (Whitten), small rovers (Skilton), ruckmen (Dyer) - and the structural shift is unmistakable.

**If the goals leaderboard could be era-adjusted**, the projection is straightforward: take each player's goals-per-game and rebase against the contemporaneous league average for forwards in their era. On that adjustment, the top of the all-time chart would re-rank as Hudson (5.81 goals/game peak) → Pratt → Coleman → Lockett, with Franklin almost certainly in the top six. Hawkins and Riewoldt move up substantially; Wade and McKenna move down slightly. The point is not the new ordering. The point is that the volume leaderboard above understates Hudson, Pratt and Coleman, and overstates the late-1980s/early-1990s forwards. The [era-normalised top 100](hall-of-fame-top100.md) does this adjustment formally; this page is the deliberately unfiltered counterpart.
