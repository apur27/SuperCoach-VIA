...
> Sub-pages are auto-generated from `data/player_data/*_performance_details.csv` (13,329 player files). Reproduce the numbers by running `docs/hall-of-fame/compute_stat_leaders.py`. Charts regenerated by `docs/hall-of-fame/generate_records_charts.py`.
