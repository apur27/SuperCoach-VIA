...
python prediction_cpu.py   # or prediction.py if you have a GPU
```

Open `data/prediction/next_round_*_prediction_*.csv` in Excel for this week's predicted disposals.
