...
<!-- NEWS-LATEST-START -->
**Latest:** [The AFL National Draft: Error, Structure, and the Shape of Talent](docs/articles/afl-draft-analysis-2025.md) - 5-part deep analysis: error taxonomy, elite school pipeline, brand-currency thesis, data-mining decision framework (pick cliff at 16, club efficiency 3-to-1 spread, state pipelines), and a Richmond case study (0 A+/A from 32 post-dynasty picks). 1,538 National picks, 2004–2025. *(2026-06-16)*
