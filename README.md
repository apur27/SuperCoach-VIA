...
**Phase 1** uses `claude-opus-4-7` (Senior Coach), `claude-sonnet-4-6` specialists, and a `claude-haiku-4-5` data steward, invoked through the Claude Code Agent pattern with prompt-based scoping and model-driven tool calls.
...
<!-- NEWS-LATEST-START -->
**Latest:** [AFL Hall of Fame — 100 Forgotten Heroes](docs/hall-of-fame-forgotten-heroes.md) - 95 unique underappreciated AFL players across 8 categories, data-verified from 13,328 player CSVs *(2026-05-30)*
