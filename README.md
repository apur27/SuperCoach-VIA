...
<!-- NEWS-LATEST-START -->
**Latest:** [The AFL National Draft: Error, Structure, and the Shape of Talent](docs/articles/afl-draft-analysis-2024.md) - 2-part analysis of draft error taxonomy (commission vs omission errors), elite school pipeline (21.3% of picks, 28.2% of top 10 — but identical conversion rates to non-elite peers), superdraft depth, and the mid-season draft that mostly doesn't correct. 1,538 National picks, 2004–2025. *(2026-06-16)*
