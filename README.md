...
| 2 | **FootyStrategy** | Opus | Tactical interpretation | Eight-lens coaching council (Structuralist, Culture Custodian, List Strategist, Match-up Tactician, Momentum Reader, Contrarian, Pressure Tester, Integrator). Translates Scientist's numbers into coach-grade reads. Never names specific coaches without attribution. |
