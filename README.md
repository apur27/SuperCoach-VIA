...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/data-2026%20season%20round%2020-green">
...
| Backtest window | **[data]** R1–R20, 2026 | `data/prediction/backtest/` |
| Player-round predictions scored | **[data]** 7,153 | walk-forward backtest |
...
Walk-forward backtest, 2026 season, Rounds 1–20. For each round the model is retrained using only data from before that round, predicts every player who played, and is scored against actuals.

| Window | Player-rounds | MAE | Within 5 | Within 10 | Bias |
|---|--:|--:|--:|--:|--:|
| **R1-R20 player-weighted** | **[data]** 7,153 | **[data]** 3.958 | **[data]** 74.4% | **[data]** 95.8% | **[data]** -0.110 |
