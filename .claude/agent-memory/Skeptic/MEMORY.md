...
- [Recap Tactical-note causal relapse](feedback_recap_tactical_note_causal_relapse.md) — rewrites keep the disclaimer but re-import causation via the verb; also watch season-aggregate figures narrated as "this round" and untagged "extended/largest" ladder superlatives
