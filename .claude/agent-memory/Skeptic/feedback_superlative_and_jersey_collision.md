...
**Ties are the sharpest tell.** Two entries at an *identical* verified value can get opposite superlative framings in different sections. Real example (2026 hall-of-fame Goal Machines): Brian Taylor and Mark Jackson both 3.76 gpg — Taylor written as "second in this group only to Lindsay White" (3.80) while Jackson at the same 3.76 written as "level with the best in this group / matches the very best here." Both cannot be true: they are equal-second behind White, Jackson is NOT level with the 3.80 best. When you rebuild the sort, explicitly group ties and check every entry sharing a value uses the *same* comparative phrasing. Also watch hedged-but-wrong "among the best in this group" on a mid/low-ranked value (Beecroft 3.03 ranked 11th of 13, still called "among the best").
